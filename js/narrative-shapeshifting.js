$(document).ready(function() {
	...
	if (wS > (hT+hH-wH)) {
		setTimeout(function(){
			$("#event1 .text-superscript:nth-child(1)").animate({
			opacity: 1
			}, 5000);
		},1500);
		
		setTimeout(function(){
			$("#event1 .text-superscript:nth-child(2)").animate({
			opacity: 1
			}, 5000);
		},7500);
	...
	if (wS > (hT+hH-wH)) {
		...
		setTimeout(function(){
			$("#event7 .text-superscript:nth-child(1)").animate({
			opacity: 1
			}, 5000);
		},4500);
		
		setTimeout(function(){
			$("#event7 .text-superscript:nth-child(2)").animate({
			opacity: 1
			}, 5000);
		},7000);
