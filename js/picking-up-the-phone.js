$(document).ready(function() {
	...
	if (wS > (hT+hH-wH)) {
		setTimeout(function(){
			$("#event1 p:nth-child(1)").animate({ opacity: 1 }, (4000));
		},2000);
		
		setTimeout(function(){
			$("#event1 p:nth-child(2)").animate({ opacity: 1 }, (4000));
		},4000);
	...
	if (wS > (hT+hH-wH)) {
		setTimeout(function(){
			$("#event4 p:nth-child(1)").animate({ opacity: 1 }, (4000));
		},2000);
		
		setTimeout(function(){
			$("#event4 p:nth-child(2)").animate({ opacity: 1 }, (4000));
		},4000);
